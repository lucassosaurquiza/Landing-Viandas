      ...
      <div className="border flex justify-center text-center p-2">
        <div className="max-w-3xl mt-10 mb-10">
          ...
          <div className="md:flex  justify-center gap-5 p-3 mb-10">
            <div className="flex-col flex justify-center items-center mb-5 bg-orange-300 p-5 rounded-md shadow-xl">
            ...
            <div className="flex-col flex justify-center items-center bg-orange-300 p-5 rounded-md shadow-xl">
              <p className="text-white font-semibold mb-3">
                /  Milanesa Napolitana de carne con pure
              </p>
              <img className="relative w-60 h-40 md:h-32 rounded-full"  src="/milanesa-napolitana.jpg" alt="" />
            </div>
          </div>
