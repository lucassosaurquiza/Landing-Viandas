    ...
    <section>
      ...
      <div className="border flex justify-center text-center ">
        <div className="max-w-3xl mt-10 mb-10">
          <h2 className="text-4xl font-extrabold flex justify-center mb-10 text-orange-500">LO MEJOR EN VIANDAS INDIVIDUALES</h2>
          ...
          <h2 className="flex justify-center text-center mb-5 font-bold md:text-3xl">
            Informate de lo que podes encontrar en nuestro menu individual a continuacion:
          </h2>
          <div className=" flex flex-col items-center mb-5">
            <div className="border bg-orange-300 p-5">
              ...
              <p className="text-white mb-1 text-xs lg:text-lg  font-bold">
              ...
              <p className="text-white mb-5  text-xs lg:text-lg  font-bold">
          ...
          <h2 className="text-lg md:text-4xl font-bold flex justify-center mb-5">Algunos de nuestros menus de la semana</h2>
          <div className="md:flex  justify-center gap-5 p-3">
