...
export default function Home() {
  ...
  return (
    <main className="relative flex flex-col items-center justify-center h-screen text-white">
      ...
      <img className="absolute md:top-5 md:right-5 md:h-48 md:w-60 top-3 h-40 w-56 lg:h-24 lg:w-32" src="/logo.png" alt="" />
      ...
      <div className="absolute top-52 md:top-72  md:flex md:gap-10 p-3">
        <Link href='/viandas-X1'>
          <section className="border p-5 cursor-pointer hover:bg-orange-300 hover:scale-105 transition duration-300 ease-in-out rounded-lg mb-5 hover:border-none">
            ...
            <p className="text-white border-white border-2 justify-center flex bg-gray-800 p-2 md:text-xl ">
              + info del plan
            </p>
        ...
        <Link href='/viandas-X3'>
          <section className=" p-5 cursor-pointer hover:bg-amber-800 hover:scale-105 transition duration-300 ease-in-out rounded-lg border hover:border-none mb-5">
            <div className="border-2 border-gray-800 flex justify-center items-center flex-col h-full mb-5">
              <h2 className=" lg:text-2xl  font-bold  text-white ">
        ...
        <Link href='/viandas-X5'>
          <section className=" p-5 cursor-pointer hover:bg-amber-300 hover:scale-105 transition duration-300 ease-in-out rounded-lg border hover:border-none">
            <div className="border-2 border-gray-800 flex justify-center items-center flex-col h-full mb-5">
              <h2 className=" lg:text-2xl  font-bold  text-white ">
